###########################################################################
## Makefile generated for component 'Total_Pjt'. 
## 
## Makefile     : Total_Pjt.mk
## Generated on : Wed Jan 22 14:02:41 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Total_Pjt.exe
...
PRODUCT_NAME              = Total_Pjt
MAKEFILE                  = Total_Pjt.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2023b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2023b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\User\AURIX-v1.10.6-workspace\Ex_Pjt_Total\Model
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Total_Pjt_comp.rsp
CMD_FILE                  = Total_Pjt.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Total_Pjt.exe
...
DEFINES_STANDARD = -DMODEL=Total_Pjt -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\Total_Pjt_ert_rtw\Total_Pjt.c

MAIN_SRC = $(START_DIR)\Total_Pjt_ert_rtw\ert_main.c
...
{$(START_DIR)\Total_Pjt_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Total_Pjt_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Total_Pjt_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Total_Pjt_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Total_Pjt.obj : "$(START_DIR)\Total_Pjt_ert_rtw\Total_Pjt.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Total_Pjt_ert_rtw\Total_Pjt.c"


ert_main.obj : "$(START_DIR)\Total_Pjt_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Total_Pjt_ert_rtw\ert_main.c"
