...
void blink_led(void)
{
    /* 10.1 RED LED On, 10.2 BLUE LED Off Wait 500ms */
    IfxPort_setPinHigh(&MODULE_P10, 1);
    IfxPort_setPinLow(&MODULE_P10, 2);
    waitTime(IfxStm_getTicksFromMilliseconds(BSP_DEFAULT_TIMER, WAIT_TIME)); /* Wait 500ms */

    /* 10.1 RED LED Off, 10.2 BLUE LED On Wait 500ms */
    IfxPort_setPinLow(&MODULE_P10, 1);
